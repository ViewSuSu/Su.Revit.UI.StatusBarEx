...
namespace Su.Revit.UI.StatusBarEx.HighVersion.StatusBar.Extensions
{
    /// <summary>
    /// ResourceHelper
    /// </summary>
    internal static class ResourceHelper
    {
        ...
        public static bool SimilarSource(this ResourceDictionary resource, ResourceDictionary other)
        {
            ...
            return resourceSource.EndsWith(otherSource, StringComparison.InvariantCultureIgnoreCase)
                || otherSource.EndsWith(
                    resourceSource,
